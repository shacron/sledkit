...
BLD_TARGET_OBJDUMP ?= $(BLD_TOOLCHAIN_BINDIR)/llvm-objdump
BLD_TARGET_RANLIB ?= $(BLD_TOOLCHAIN_BINDIR)/llvm-ranlib
BLD_TARGET_CONFIG ?= $(BLD_TOOLCHAIN_BINDIR)/llvm-config
